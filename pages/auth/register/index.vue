    ...
    <div class="inner">
      <div class="lhs">
        ...
        <div v-else class="mobile inner_ come-up no_show">
          ...
          <p class="sub-title">
            Information provided here should be your personal Information
          </p>
          <div class="form">
            <div v-if="error">
            ...
            <div class="input-box">
              ...
              <div class="new_input">
                ...
                <input v-model="email" placeholder="Email Address" type="email" name="email" @focus="error = false">
              </div>
            </div>
            <div class="input-box">
              <p class="label">
              ...
              <div class="new_input">
                ...
                <input v-model="phone" placeholder="08012345678" type="number" name="phone_number" @focus="error = false">
              </div>
            </div>
            <div class="input-box">
              <p class="label">
              ...
              <div class="new_input">
                ...
                <input v-model="password" placeholder="Enter Password" :type="type" @focus="error = false">
                <svg
                  v-if="type === 'password'"
                  class="pass_svg"
                  width="24"
      ...
      <div class="rhs">
        <div class="rhs_inner">
          <div class="top_btn">
            <button class="trans_btn" @click="$router.push('/auth/login')">
              Login
            </button>
          </div>
...
export default {
  ...
  methods: {
    ...
    register () {
      ...
      if (
        this.email.replace(/ /g, '').length < 3 ||
        !this.email.includes('@')
      ) {
        this.error = true
        this.errorText = 'Invalid Email Address'
      } else if (this.phone.replace(/[^\d.-]/g, '').length < 11 ||
          this.containsSpecialChars2(this.phone)
      ) {
        this.error = true
        this.errorText = 'Invalid Phone Number'
      } else if (!this.checked) {
        this.errorText = 'Please Accept our Terms of Service'
        this.error = true
      } else {
        this.loading = true
...
.check-container:hover .check-input ~ .checkmark {
