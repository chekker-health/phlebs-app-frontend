<template>
  <div class="container">
    <div v-if="showPdf" class="pdf_ctn come-down">
      <div class="pdf_top">
        <p class="pdf_text">
          Please Read...
        </p>
        <button class="pdf_btn" @click="showPdf = false">
          Continue to Dashboard
        </button>
      </div>
      <iframe
        src="https://drive.google.com/file/d/1bP9FaLbRGFwMaglBa9TjO94QpLR5Y7pX/preview?usp=sharing#toolbar=0"
        frameborder="0"
        width="100%"
        height="100%"
      />
...
export default {
  ...
  data () {
    return {
      ...
      fromPath: 'rt',
      warning: false,
      pdfSource: 'assets/pdf/Chekker Medical Mold.pdf',
  ...
  methods: {
    ...
    // },
    getUserDetails () {
      // console.log(this.fromPath.name)
      if (this.fromPath.name === 'auth-register-details') {
        this.showPdf = true
      }
      this.loading = true
